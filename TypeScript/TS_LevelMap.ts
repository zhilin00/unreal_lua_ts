...
class TS_LevelMap {
    ...
    ReceiveTick(DeltaSeconds: number) {
        ...
        if (this.SpawnCnt < this.SpawnNum) {
            ...
            let enemy = UE.GameplayStatics.BeginDeferredActorSpawnFromClass(world, TSEnemyWithMixin.StaticClass(), newTransform, UE.ESpawnActorCollisionHandlingMethod.AlwaysSpawn) as TS_Enemy;
