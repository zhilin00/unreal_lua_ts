...
ULuaEnvGameInstance::ULuaEnvGameInstance() : state(nullptr)
{
...
void ULuaEnvGameInstance::CreateLuaState()
{
	NS_SLUA::LuaState::onInitEvent.AddUObject(this, &ULuaEnvGameInstance::LuaStateInitCallback);
...
void ULuaEnvGameInstance::CloseLuaState()
{
	if (state)
	{
		state->close();
...
void ULuaEnvGameInstance::Init()
{
	Super::Init();
}

void ULuaEnvGameInstance::Shutdown()
{
	CloseLuaState();
...
void ULuaEnvGameInstance::LuaStateInitCallback(NS_SLUA::lua_State* L)
{
