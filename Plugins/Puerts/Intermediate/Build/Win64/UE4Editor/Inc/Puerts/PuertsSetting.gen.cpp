...
// End Cross Module References
	...
	struct Z_Construct_UClass_UPuertsSetting_Statics
	{
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RootPath_MetaData[];
#endif
		...
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_IgnoreClassListOnDTS_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IgnoreClassListOnDTS_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_IgnoreClassListOnDTS;
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_IgnoreStructListOnDTS_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IgnoreStructListOnDTS_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_IgnoreStructListOnDTS;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPuertsSetting_Statics::NewProp_RootPath_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPuertsSetting_Statics::NewProp_RootPath = { "RootPath", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPuertsSetting, RootPath), METADATA_PARAMS(Z_Construct_UClass_UPuertsSetting_Statics::NewProp_RootPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPuertsSetting_Statics::NewProp_RootPath_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreClassListOnDTS_Inner = { "IgnoreClassListOnDTS", nullptr, (EPropertyFlags)0x0000000000004000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreClassListOnDTS_MetaData[] = {
		{ "Category", "Declaration Generator" },
		{ "DisplayName", "D.ts Ignore Class Name List" },
		{ "ModuleRelativePath", "Private/PuertsSetting.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreClassListOnDTS = { "IgnoreClassListOnDTS", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPuertsSetting, IgnoreClassListOnDTS), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreClassListOnDTS_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreClassListOnDTS_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreStructListOnDTS_Inner = { "IgnoreStructListOnDTS", nullptr, (EPropertyFlags)0x0000000000004000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreStructListOnDTS_MetaData[] = {
		{ "Category", "Declaration Generator" },
		{ "DisplayName", "D.ts Ignore Struct Name List" },
		{ "ModuleRelativePath", "Private/PuertsSetting.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreStructListOnDTS = { "IgnoreStructListOnDTS", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPuertsSetting, IgnoreStructListOnDTS), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreStructListOnDTS_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreStructListOnDTS_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPuertsSetting_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPuertsSetting_Statics::NewProp_RootPath,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreClassListOnDTS_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreClassListOnDTS,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreStructListOnDTS_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPuertsSetting_Statics::NewProp_IgnoreStructListOnDTS,
	};
	...
	IMPLEMENT_CLASS(UPuertsSetting, 3355980439);
